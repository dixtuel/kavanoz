...
// .wrangler/tmp/pages-mc0exg/functionsWorker-0.2031813419680144.mjs
...
var init_crypto = __esm({
  "_lib/crypto.js"() {
    ...
    init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_console();
    init_performance2();
    __name2(loadKey, "loadKey");
    __name2(encrypt, "encrypt");
    __name2(decrypt, "decrypt");
    __name2(generateManagementKey, "generateManagementKey");
    __name2(hashManagementKey, "hashManagementKey");
    __name2(compressText, "compressText");
    __name2(decompressText, "decompressText");
  }
});
...
var init_db = __esm({
  "_lib/db.js"() {
    ...
    init_turso();
    init_crypto();
    __name2(jarCapacity, "jarCapacity");
    __name2(getOrCreateActiveJar, "getOrCreateActiveJar");
    __name2(createNote, "createNote");
    __name2(noteRowToPublic, "noteRowToPublic");
    __name2(listJarNotes, "listJarNotes");
    __name2(getNote, "getNote");
    __name2(getActiveJarSummary, "getActiveJarSummary");
    __name2(listShelf, "listShelf");
    __name2(countShelf, "countShelf");
    __name2(getJarMeta, "getJarMeta");
    __name2(findNoteByManagementKeyHash, "findNoteByManagementKeyHash");
    __name2(deleteNoteById, "deleteNoteById");
    __name2(updateNoteById, "updateNoteById");
  }
});
...
var init_response = __esm({
  "_lib/response.js"() {
    ...
    __name2(isValidEmailSyntax, "isValidEmailSyntax");
    MAX_YEARS = 5;
    __name2(maxFutureDate, "maxFutureDate");
    __name2(validateFutureDate, "validateFutureDate");
  }
});
...
var require_wordlist = __commonJS({
  "../server/wordlist.js"(exports, module) {
    ...
    __name2(containsBlockedWord, "containsBlockedWord");
    function matchesSpamPattern(text) {
      return SPAM_PATTERNS.some((pattern) => pattern.test(text));
    }
    __name(matchesSpamPattern, "matchesSpamPattern");
    __name2(matchesSpamPattern, "matchesSpamPattern");
    function quickFilterReject2(text) {
      return containsBlockedWord(text) || matchesSpamPattern(text);
    }
    __name(quickFilterReject2, "quickFilterReject2");
    __name2(quickFilterReject2, "quickFilterReject");
...
var init_moderation = __esm({
  "_lib/moderation.js"() {
    ...
    TASK_TEMPLATE = /* @__PURE__ */ __name2((text) => `Task: Check if there is unsafe content in the user or agent messages in the below conversation in accordance with our safety policy with the below categories. Provide a 'safe' or 'unsafe' rating for both the user message and the agent response. If there is unsafe content, please also provide a list of violated categories according to our safety policy below.
...
Output JSON: `, "TASK_TEMPLATE");
    __name2(classifyWithNim, "classifyWithNim");
    __name2(moderateMessage, "moderateMessage");
    __name2(verifyHcaptcha, "verifyHcaptcha");
    __name2(hasMx, "hasMx");
  }
});
...
// .wrangler/tmp/bundle-apKWcJ/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-apKWcJ/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.2031813419680144.js.map
